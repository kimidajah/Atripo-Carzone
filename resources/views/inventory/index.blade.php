...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1">Stok Mobil & Status Persediaan</h3>
        <p class="text-muted small mb-0">Memantau kondisi stok armada secara real-time di Atripo Carzone Cileunyi</p>
    </div>
    <div class="d-flex gap-2">
        ...
        @if(Auth::user()->isAdmin())
            <a href="{{ route('cars.create') }}" class="btn btn-gold btn-sm px-3 d-flex align-items-center">
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-3">
        <div class="card border-0 shadow-sm p-3 text-center bg-white border-bottom border-4 border-warning">
            <div class="text-muted small fw-bold text-uppercase">Dipesan / Booking</div>
                    ...
                    <div class="position-relative bg-dark" style="height: 200px; overflow: hidden;">
                        ...
                        <div class="position-absolute top-0 end-0 m-2">
                            @if($car->status === 'tersedia')
                                <span class="badge badge-available shadow-sm px-2.5 py-1.5">TERSDIA</span>
                    ...
                    <tbody>
                        @forelse($cars as $car)
                            <tr>
                                ...
                                <td><span class="badge bg-light text-dark border">{{ $car->year }}</span></td>
                                <td><span class="font-monospace fw-semibold">{{ $car->plate_number }}</span></td>
