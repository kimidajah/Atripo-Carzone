...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1">Data Mobil</h3>
        <p class="text-muted small mb-0">Kelola armada kendaraan yang tersedia di Atripo Carzone Cileunyi</p>
    </div>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body p-3">
        <form action="{{ route('cars.index') }}" method="GET" class="row g-2 align-items-center">
            ...
            <div class="col-md-1">
                <button type="submit" class="btn btn-gold w-100"><i class="bi bi-filter"></i></button>
            </div>
        </form>
    </div>
</div>
